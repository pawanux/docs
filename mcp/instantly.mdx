---
title: "Instantly"
icon: "https://cdn.simpleicons.org/instantly"
...
![The Instantly account menu, with Settings near the bottom](/images/mcp/instantly/setup/01-account-menu-settings.png)
</Step>
...
![The Integrations tab in Instantly Settings](/images/mcp/instantly/setup/02-settings-integrations.png)
</Step>
...
![The API Keys section, with Version 2 selected and the Create API Key button](/images/mcp/instantly/setup/03-api-keys.png)
</Step>
...
![The Create API Key form, with Name and Scopes fields](/images/mcp/instantly/setup/04-create-api-key.png)
...
<Step title="Pick Instantly from the Apps panel">
In the **Paths** panel, open the **Apps** tab and select **Instantly**. Use the search box if you have many connectors.
