...
<Step title="Pick Google Analytics from the Apps panel">
In the **Paths** panel, open the **Apps** tab and select **Google Analytics**. Use the search box if you have many connectors.
