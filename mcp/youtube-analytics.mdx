...
<Step title="Pick YouTube Analytics from the Apps panel">
In the **Paths** panel, open the **Apps** tab and select **YouTube Analytics**. Use the search box if you have many connectors.
