...
Open **Workflows → New Workflow**. On the canvas, click **+ Add Trigger**. In the **Paths** panel, open the **Apps** tab and select **Calendly** — its **Triggers** are listed underneath. Use the search box if you have many connectors.
</Step>
<Step title="Add an action node">
Click the **+** below any node to add a step, then pick **Calendly** again — this time the panel lists its **Actions**.

![Calendly actions in the Apps panel](/images/mcp/calendly/workflows/07-apps-actions.png)
</Step>
