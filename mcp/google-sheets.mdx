...
![Configure the selected trigger or tool](/images/mcp/workflows/08-trigger-config.png)
</Step>
<Step title="Add or select your account">
Under **Selected account**, choose an already-connected account, or click **Add Account** to connect one now.

![Select an account or add a new one](/images/mcp/workflows/09-select-account.png)
</Step>
