...
<Step title="Pick Google Chat from the Apps panel">
In the **Paths** panel, open the **Apps** tab and select **Google Chat**. Use the search box if you have many connectors.
