...
Once connected, you can add **Google Docs** to any automation from the **Workflows** builder. Its triggers and tools appear in the Apps panel, marked with an **MCP** badge.

<Steps>
<Step title="Add a trigger node">
Open **Workflows → New Workflow**. On the canvas, click **+ Add Trigger**. In the **Paths** panel, open the **Apps** tab and select **Google Docs** — its **Triggers** are listed underneath. Use the search box if you have many connectors.

![Google Docs triggers in the Apps panel](/images/mcp/google-docs/workflows/06-apps-triggers.png)
</Step>
<Step title="Add an action node">
Click the **+** below any node to add a step, then pick **Google Docs** again — this time the panel lists its **Actions**.

![Google Docs actions in the Apps panel](/images/mcp/google-docs/workflows/07-apps-actions.png)
</Step>
