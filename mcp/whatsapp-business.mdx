...
Open **Workflows → New Workflow**. On the canvas, click **+ Add Trigger**. In the **Paths** panel, open the **Apps** tab and select **WhatsApp Business** — its **Triggers** are listed underneath. Use the search box if you have many connectors.

![WhatsApp Business triggers in the Apps panel](/images/mcp/whatsapp-business/workflows/06-apps-triggers.png)
</Step>
<Step title="Add an action node">
Click the **+** below any node to add a step, then pick **WhatsApp Business** again — this time the panel lists its **Actions**.

![WhatsApp Business actions in the Apps panel](/images/mcp/whatsapp-business/workflows/07-apps-actions.png)
</Step>
