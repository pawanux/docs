...
Sign in at [https://www.tryunleashx.com](https://www.tryunleashx.com) and open the agent you want to give Slack access to.
</Step>
...
Open **Workflows → New Workflow**. On the canvas, click **+ Add Trigger**. In the **Paths** panel, open the **Apps** tab and select **Slack** — its **Triggers** are listed underneath. Use the search box if you have many connectors.

![Slack triggers in the Apps panel](/images/mcp/slack/workflows/06-apps-triggers.png)
</Step>
<Step title="Add an action node">
Click the **+** below any node to add a step, then pick **Slack** again — this time the panel lists its **Actions**.

![Slack actions in the Apps panel](/images/mcp/slack/workflows/07-apps-actions.png)
</Step>
