...
Open **Workflows → New Workflow**. On the canvas, click **+ Add Trigger**. In the **Paths** panel, open the **Apps** tab and select **Cal.com** — its **Triggers** are listed underneath. Use the search box if you have many connectors.

![Cal.com triggers in the Apps panel](/images/mcp/calcom/workflows/06-apps-triggers.png)
</Step>
<Step title="Add an action node">
Click the **+** below any node to add a step, then pick **Cal.com** again — this time the panel lists its **Actions**.

![Cal.com actions in the Apps panel](/images/mcp/calcom/workflows/07-apps-actions.png)
</Step>
