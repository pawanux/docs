---
title: "Pipedrive"
icon: "/images/logos/pipedrive.svg"
...
Open **Workflows → New Workflow**. On the canvas, click **+ Add Trigger**. In the **Paths** panel, open the **Apps** tab and select **Pipedrive** — its **Triggers** are listed underneath. Use the search box if you have many connectors.

![Pipedrive triggers in the Apps panel](/images/mcp/pipedrive/workflows/06-apps-triggers.png)
</Step>
<Step title="Add an action node">
Click the **+** below any node to add a step, then pick **Pipedrive** again — this time the panel lists its **Actions**.

![Pipedrive actions in the Apps panel](/images/mcp/pipedrive/workflows/07-apps-actions.png)
</Step>
