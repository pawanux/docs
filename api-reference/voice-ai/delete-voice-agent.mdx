...
openapi: "api-reference/openapi.json POST /global/agents/delete"
---
...
### Using Request Body
```bash
curl -X POST https://your-domain.com/api/v1/global/agents/delete \
...
```bash
curl -X POST "https://your-domain.com/api/v1/global/agents/delete?agent_id=123" \
  -H "Content-Type: application/json" \
  -H "token: your_api_token_here"
```
