...
```bash
curl -X GET "https://your-api-domain.com/api/v1/voice-list?provider_id=elevenlabs&page_token=YOUR_NEXT_PAGE_TOKEN" \
...
```bash
curl -X POST "https://your-api-domain.com/api/v1/global/agents" \
