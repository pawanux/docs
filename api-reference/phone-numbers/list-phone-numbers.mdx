...
| `number_type` | string | No | Filter by number type: `local`, `toll_free`, `mobile` |
...
| `OUTBOUND` | Number dedicated for outbound calls |
| `INBOUND` | Number dedicated for inbound calls |
| `SUPPORT` | Number for customer support |
| `SALES` | Number for sales operations |
