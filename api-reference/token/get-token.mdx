...
openapi: "api-reference/openapi.json GET /get-token"
---
...
```
**Note:** To generate the OTP, invoke the login API using only the username. After receiving the OTP, invoke the login API again with both the username and the OTP
